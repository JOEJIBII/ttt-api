            ...
            .aggregate([
                ...
                },
                {
                    ...
                    $project: {
                        ...
                        banking_account: {account_number:"$bank.account_number",account_name:"$bank.account_name"},
                        financial: "$financial",
                        status: "$status",
                        status_newmember: "$status_newmember",
                        create_date: "$create_date",
                ...
                },
                {
                    ...
                    $project: {
                        ...
                        profile: "$profile",
                        bank_id:"$bank.bank_id",
                        banking_account: {account_number:"$banking_account.account_number",account_name:"$banking_account.account_name",bank_code:"$banking.code"},
                        financial: "$financial",
                        status: "$status",
                        status_newmember: "$status_newmember",
                        create_date: "$create_date",
