            ...
            .aggregate([
                ...
                },
                {
                    ...
                    $project: {
                        ...
                        username_provider: "$username_provider",
                        profile: "$profile",
                        banking_account: {bank_id:"$bank._id",account_bank_id:"$banking_account.account_bank_id",account_number:"$banking_account.account_number",account_name:"$banking_account.account_name",bank_code:"$banking.code"},
                        financial: "$financial",
                        status: "$status",
                        status_newmember: "$status_newmember",
                        create_date: "$create_date",
